...
This gem requires [Bourbon 4](https://www.bourbon.io/docs/4/), [JQuery](https://jquery.com/) and [Sass](https://github.com/sass/sass). Some components may require [JQueryUI](https://jqueryui.com) as well.   
